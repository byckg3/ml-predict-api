...
async def save_record( service: ServiceDependency, 
                       record: LiverDiseaseRecord = Body( ..., example = example[ "created_record" ] ) ) -> LiverDiseaseRecord:
...
async def put_record( id: PydanticObjectId, service: ServiceDependency, 
                      patch: dict[ str, Any ] = Body( ..., example = example[ "updated_value1" ] ) ) -> LiverDiseaseRecord:
...
async def update_record( id: PydanticObjectId, service: ServiceDependency, 
                         patch: dict[ str, Any ] = Body( ..., example = example[ "updated_value2" ] ) ) -> LiverDiseaseRecord:
